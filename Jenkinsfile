pipeline {
    agent any
    environment {
        DOCKER_HUB_USERNAME = credentials('DOCKER_HUB_USERNAME') // Fetches from GitHub Secrets
        DOCKER_HUB_PASSWORD = credentials('DOCKER_HUB_PASSWORD') // Fetches from GitHub Secrets
